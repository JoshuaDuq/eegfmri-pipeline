...
def test_build_power_construct_figure_has_publication_structure() -> None:
    ...
    try:
        assert np.allclose(figure.get_size_inches(), (183.0 / 25.4, 108.0 / 25.4))
        ...
        assert figure.axes[5].get_title(loc="left") == (
