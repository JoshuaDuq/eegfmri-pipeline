...
from studies.pain_study.eeg_coupling.analysis.eeg_bold_coupling import (
...
def test_compute_dvars_table_adds_trialwise_dvars_column(
    ...
    monkeypatch.setattr(
        "studies.pain_study.eeg_coupling.analysis.eeg_bold_nuisance.discover_fmriprep_preproc_bold",
        lambda **_kwargs: bold_path,
    )
    monkeypatch.setattr(
        "studies.pain_study.eeg_coupling.analysis.eeg_bold_nuisance.discover_confounds",
        lambda **_kwargs: confounds_path,
    )
    monkeypatch.setattr(
        "studies.pain_study.eeg_coupling.analysis.eeg_bold_nuisance.get_tr_from_bold",
        lambda _path: 1.0,
    )
    monkeypatch.setattr(
        "studies.pain_study.eeg_coupling.analysis.eeg_bold_nuisance.nib.load",
...
def test_leave_one_out_refits_calls_fit_for_each_subject_and_run(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "studies.pain_study.eeg_coupling.analysis.eeg_bold_coupling.fit_mixedlm_cell",
