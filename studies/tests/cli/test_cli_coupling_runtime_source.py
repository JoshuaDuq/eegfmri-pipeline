...
from studies.pain_study.cli.command_registry import coupling_command
...
""".strip()
    ...
    monkeypatch.setattr(
        "studies.pain_study.eeg_coupling.cli.coupling.EEGBOLDCouplingPipeline",
