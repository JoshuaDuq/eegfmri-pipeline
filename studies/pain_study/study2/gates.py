"""Study 2 confirmatory criteria inherited from Study 1."""
...
class Study1ConfirmatoryCriteriaQC:
    confirmatory_criteria_met: bool
...
def evaluate_study1_confirmatory_criteria(
    metrics: Mapping[str, object],
    config: Any,
) -> Study1ConfirmatoryCriteriaQC:
    """Evaluate configured Study 1 criteria for confirmatory Study 2 entry."""
    ...
    if mean_delta_r2 <= 0.0 or p_value_delta_r2_holm > max_holm_p:
        unmet_criteria.append("significant_positive_delta_r2")
    if min_delta_r2 is not None and mean_delta_r2 < min_delta_r2:
        unmet_criteria.append("practical_effect_delta_r2")
    if min_delta_r2_lower_ci is not None:
        ...
        if delta_r2_lower_ci <= min_delta_r2_lower_ci:
            unmet_criteria.append("practical_effect_lower_ci")
    if min_level2_delta_r2 is not None:
        ...
        if level2_mean_delta_r2 < min_level2_delta_r2:
            unmet_criteria.append("level2_delta_r2")
    if min_target_split_half_reliability is not None:
        ...
        if target_split_half_reliability < min_target_split_half_reliability:
            unmet_criteria.append("target_split_half_reliability")
    if min_target_reliability_n_trials is not None:
        ...
        if target_reliability_n_trials < min_target_reliability_n_trials:
            unmet_criteria.append("target_reliability_n_trials")
    ...
    return Study1ConfirmatoryCriteriaQC(
        confirmatory_criteria_met=not unmet,
