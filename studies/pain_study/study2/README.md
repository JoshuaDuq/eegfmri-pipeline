...
hyperparameters are frozen before source-map construction. Study 2 cannot influence Study 1 model
...
maps across held-out source-valid subjects, after projecting each fold map to the Study 2 cortical
