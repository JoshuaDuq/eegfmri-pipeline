...
This file tracks subject-level validity and QC checks for Study 1 and Study 2.
It is a subject QC log, not a group-results report. Keep group inference,
model significance, clusters, and manuscript-style interpretation in the
generated study reports.
...
## Generated QC Summary

These flags come from the current generated subject QC package. `PASS` means the
subject passes that QC category. `WARNING` means the subject is usable for the
relevant stage but has a documented limitation. `FAIL` means the subject is
excluded from that stage.

| Subject | Study 1 flag | Excluded retained run(s) | Reduced retained run counts | Stimulus temperatures | Selected surfaces | Temporal flag | Study 2 flag | Study 2 anatomy status |
| --- | --- | --- | --- | ---: | ---: | --- | --- | --- |
| `sub-0000` | PASS | -- | -- | 6 | 5 | WARNING | FAIL | BEM invalid / source excluded |
| `sub-0001` | WARNING | -- | 5:10 | 6 | 5 | PASS | FAIL | trans + BEM |
| `sub-0002` | FAIL | 1,2,3,4,5,6 | -- | 0 | 0 | FAIL | FAIL | excluded incomplete session |
| `sub-0003` | WARNING | 3 | -- | 6 | 5 | WARNING | PASS | trans + BEM |
| `sub-0004` | WARNING | -- | 2:10, 3:9, 5:7, 6:10 | 6 | 5 | WARNING | FAIL | BEM invalid / source excluded |
| `sub-0005` | WARNING | -- | 3:10, 4:8, 6:10 | 6 | 5 | WARNING | WARNING | trans + BEM |

## Cohort Status

| Subject | Study 1 status | Study 2 status | Validity note |
| --- | --- | --- | --- |
| `sub-0000` | Included | Excluded | Study 1 target checks passed. Study 2 source modeling is excluded because watershed BEM surfaces are anatomically invalid. |
| `sub-0001` | Included with warning | Excluded from source inference | Study 1 retained run 5 has 10 target rows. Study 2 source-stage contribution design is rank deficient. |
| `sub-0002` | Excluded | Excluded | Participant wanted out of the MRI; incomplete experiment. |
| `sub-0003` | Included with warning | Included | Run 3 is excluded because it used the run 1 temperature/surface sequence. Source-stage QC passed. |
| `sub-0004` | Included with warning | Excluded | Study 1 has reduced retained trial counts in several runs. Study 2 source modeling is excluded because watershed BEM surfaces are anatomically invalid. |
| `sub-0005` | Included with warning | Included with warning | Study 1 has reduced retained trial counts in several runs. Study 2 source arrays contain 61 rows while source-stage QC uses 53 retained rows. |
...
| Subject | Trials | Blocks | Stimulus temperatures | Selected surfaces | Mean FD | Mean stdDVARS | Mean residual ECG coupling | Mean VAS | VAS-temperature r | Mean NPS | NPS-temperature r | Mean SIIPS1 | SIIPS1-temperature r | Validity summary |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `sub-0000` | 66 | 6 | 6 | 5 | 0.049 | 1.030 | 0.073 | 78.3 | 0.904 | 3.37 | 0.624 | 1276.4 | 0.396 | Valid Study 1 subject. Strong behavioral temperature response and positive NPS-temperature coupling. |
| `sub-0001` | 65 | 6 | 6 | 5 | 0.068 | 1.006 | 0.112 | 93.6 | 0.848 | 1.60 | 0.449 | 436.6 | 0.583 | Valid Study 1 subject with reduced retained count in run 5. |
| `sub-0003` | 55 | 5 | 6 | 5 | 0.063 | 1.037 | 0.140 | 73.0 | 0.926 | -0.15 | 0.462 | 1449.9 | 0.455 | Valid Study 1 subject with run 3 excluded for duplicated run 1 temperature/surface sequence. |
| `sub-0004` | 58 | 6 | 6 | 5 | 0.091 | 1.000 | 0.190 | 102.4 | 0.818 | 3.70 | 0.501 | -128.9 | 0.032 | Valid Study 1 subject with reduced retained counts in runs 2, 3, 5, and 6. |
| `sub-0005` | 61 | 6 | 6 | 5 | 0.070 | 1.002 | 0.063 | 93.2 | 0.920 | 1.17 | 0.550 | 661.9 | 0.214 | Valid Study 1 subject with reduced retained counts in runs 3, 4, and 6. |
...
| EEG-fMRI timing specificity | Evaluated through temporal control windows and wrong-lag controls | `subject_temporal_qc.tsv` |
...
| `sub-0001` | -0.649 | -0.666 | -0.017 | 1.800 | 1.810 | Primary elastic-net delta R2 is negative for this subject. |
...
| `sub-0005` | -0.404 | -0.127 | -1.195 | -1.411 | -0.600 | -0.191 | Plateau-window delta R2 values are negative in this model. |
...
| `sub-0005` | -0.513 | -0.036 | -0.777 | -1.106 | -0.351 | -0.130 | Plateau-window delta R2 values are negative in this model. |
...
| Subject | Source status | Retained trials | Valid blocks | Design rank | Residual df | Condition number | Validity summary |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `sub-0000` | Excluded | -- | -- | -- | -- | -- | Watershed BEM surfaces are anatomically invalid. |
| `sub-0001` | Excluded | 65 | 6 | 21 | 44 | inf | Source-stage contribution design is rank deficient. |
| `sub-0003` | Included | 55 | 5 | 20 | 35 | 151.8 | Source-stage QC passed. |
| `sub-0004` | Excluded | -- | -- | -- | -- | -- | Watershed BEM surfaces are anatomically invalid. |
| `sub-0005` | Included with warning | 53 | 5 | 20 | 33 | 112.1 | Source arrays contain 61 rows while source-stage QC uses 53 retained rows. |
...
for `sub-0001`, `sub-0003`, and `sub-0005`. `sub-0000` and `sub-0004` are excluded at the
BEM stage.
