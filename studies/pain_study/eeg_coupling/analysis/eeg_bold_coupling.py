...
from studies.pain_study.eeg_coupling.analysis.eeg_bold_fmri_qc import (
    run_subject_fmri_qc,
    write_subject_fmri_qc,
)
from studies.pain_study.eeg_coupling.analysis.eeg_bold_permutation import (
    aggregate_primary_permutation_effects,
    fit_subject_primary_permutation_effects,
)
from studies.pain_study.eeg_coupling.analysis.eeg_bold_roi_builder import (
    build_eeg_bold_rois,
    built_rois_as_runtime_specs,
)
from studies.pain_study.eeg_coupling.analysis.eeg_bold_residualized import (
    aggregate_residualized_correlations,
    fit_subject_residualized_correlations,
)
from studies.pain_study.eeg_coupling.analysis.eeg_bold_signatures import (
    LocalSignatureExpressionConfig,
    normalize_signature_weights,
    resolve_signature_paths,
    sample_signatures_to_subject_surface,
)
from studies.pain_study.eeg_coupling.analysis.eeg_bold_sensitivity import (
    CouplingSensitivityConfig,
    filter_painful_trials,
    resolve_sensitivity_beta_dir,
)
from studies.pain_study.eeg_coupling.analysis.eeg_bold_source import (
    iterate_band_specific_lcmv_estimates,
    compute_source_estimates,
)
from studies.pain_study.eeg_coupling.analysis.eeg_bold_statistics import (
    CellSpec,
...
def _selected_history_events(
    *,
    ...
    if not history_parts:
        raise ValueError("No source events matched the configured EEG coupling trial selection.")
