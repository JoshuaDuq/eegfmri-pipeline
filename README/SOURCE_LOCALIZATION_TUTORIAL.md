...
```bash
# Set SUBJECTS_DIR
export SUBJECTS_DIR=/Users/joduq24/Desktop/EEG_fMRI_Pipeline/eeg_pipeline/data/derivatives/freesurfer
mkdir -p $SUBJECTS_DIR

# Set path to your FreeSurfer license
export FS_LICENSE=/Users/joduq24/Desktop/EEG_fMRI_Pipeline/eeg_pipeline/licenses/license_freesurfer.txt
...
```bash
docker run --rm \
  -v /Users/joduq24/Desktop/EEG_fMRI_Pipeline:/data \
...
mne.gui.coregistration(
    subject="sub-0000",
    subjects_dir="/Users/joduq24/Desktop/EEG_fMRI_Pipeline/eeg_pipeline/data/derivatives/freesurfer",
    inst=raw,
)
```
...
```bash
mv sub-0000-trans.fif /Users/joduq24/Desktop/EEG_fMRI_Pipeline/eeg_pipeline/data/derivatives/freesurfer/sub-0000/bem/
```
...
python -m eeg_pipeline.cli.main features compute \
  ...
  --source-subject sub-0000 \
  --source-subjects-dir /Users/joduq24/Desktop/EEG_fMRI_Pipeline/eeg_pipeline/data/derivatives/freesurfer \
  --source-trans /Users/joduq24/Desktop/EEG_fMRI_Pipeline/eeg_pipeline/data/derivatives/freesurfer/sub-0000/bem/sub-0000-trans.fif \
  --source-bem /Users/joduq24/Desktop/EEG_fMRI_Pipeline/eeg_pipeline/data/derivatives/freesurfer/sub-0000/bem/sub-0000-5120-5120-5120-bem-sol.fif \
  --source-method lcmv \
  --spatial global
```
...
recon-all \
  -subjid sub-0000 \
  -i /Users/joduq24/Desktop/EEG_fMRI_Pipeline/eeg_pipeline/data/fMRI_data/sub-0000/anat/sub-0000_acq-mprageipat2_T1w.nii.gz \
  -all \
  -sd $SUBJECTS_DIR
