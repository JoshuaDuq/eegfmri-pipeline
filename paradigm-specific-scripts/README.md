...
```bash
python paradigm-specific-scripts/run_paradigm_specific.py <command> [options]
```
...
| `--onset-reference` | `as_is` | Onset reference: `as_is`, `first_iti_start`, or `first_stim_start` |
