...
var extraPlotFieldsByPlotID = map[string][]plotItemConfigField{
	...
	"source_localization_3d_fmri_informed": {
		plotItemConfigFieldSourceBands,
		plotItemConfigFieldSourceSegment,
		plotItemConfigFieldSourceCondition,
		plotItemConfigFieldSourceSubjectsDir,
	...
	"source_glass_brain_fmri_informed": {
		plotItemConfigFieldSourceBands,
		plotItemConfigFieldSourceSegment,
		plotItemConfigFieldSourceCondition,
		plotItemConfigFieldSourceSubjectsDir,
	...
	"source_band_panel_fmri_informed": {
		plotItemConfigFieldSourceBands,
		plotItemConfigFieldSourceSegment,
		plotItemConfigFieldSourceCondition,
		plotItemConfigFieldSourceSubjectsDir,
