...
func (m Model) ExportConfig() map[string]interface{} {
	...
	cfg["sourceLocSaveStc"] = m.sourceLocSaveStc
	...
	cfg["sourceLocContrastEnabled"] = m.sourceLocContrastEnabled
	cfg["sourceLocContrastCondition"] = m.sourceLocContrastCondition
	cfg["sourceLocContrastA"] = m.sourceLocContrastA
	cfg["sourceLocContrastB"] = m.sourceLocContrastB
	cfg["sourceLocContrastMinTrials"] = m.sourceLocContrastMinTrials
	cfg["sourceLocContrastWelchStats"] = m.sourceLocContrastWelchStats
	...
	cfg["correlationsPowerSegment"] = m.correlationsPowerSegment
	...
	cfg["prepCleanEventsQCEnabled"] = m.prepCleanEventsQCEnabled
	cfg["prepCleanEventsQCEcgVarianceEnabled"] = m.prepCleanEventsQCEcgVarianceEnabled
	cfg["prepCleanEventsQCEcgVarianceOutputColumn"] = m.prepCleanEventsQCEcgVarianceOutputColumn
	cfg["prepCleanEventsQCEcgVarianceChannels"] = m.prepCleanEventsQCEcgVarianceChannels
	cfg["prepCleanEventsQCEcgVarianceWindow"] = m.prepCleanEventsQCEcgVarianceWindow
	cfg["prepCleanEventsQCPeripheralLowGammaEnabled"] = m.prepCleanEventsQCPeripheralLowGammaEnabled
	cfg["prepCleanEventsQCPeripheralLowGammaOutputColumn"] = m.prepCleanEventsQCPeripheralLowGammaOutputColumn
	cfg["prepCleanEventsQCPeripheralLowGammaChannels"] = m.prepCleanEventsQCPeripheralLowGammaChannels
	cfg["prepCleanEventsQCPeripheralLowGammaBand"] = m.prepCleanEventsQCPeripheralLowGammaBand
	cfg["prepCleanEventsQCPeripheralLowGammaWindow"] = m.prepCleanEventsQCPeripheralLowGammaWindow
	...
	cfg["fmriAnalysisScopeColumn"] = m.fmriAnalysisScopeColumn
	cfg["fmriAnalysisScopeTrialTypes"] = m.fmriAnalysisScopeTrialTypes
	cfg["fmriAnalysisPhaseColumn"] = m.fmriAnalysisPhaseColumn
	cfg["fmriAnalysisPhaseScopeColumn"] = m.fmriAnalysisPhaseScopeColumn
	cfg["fmriAnalysisPhaseScopeValue"] = m.fmriAnalysisPhaseScopeValue
	cfg["fmriAnalysisStimPhasesToModel"] = m.fmriAnalysisStimPhasesToModel
	...
	cfg["fmriTrialSigSignatureOption1"] = m.fmriTrialSigSignatureOption1
	cfg["fmriTrialSigSignatureOption2"] = m.fmriTrialSigSignatureOption2
	...
	cfg["fmriTrialSigScopeTrialTypeColumn"] = m.fmriTrialSigScopeTrialTypeColumn
	cfg["fmriTrialSigScopePhaseColumn"] = m.fmriTrialSigScopePhaseColumn
...
func (m *Model) importConfigInner(cfg map[string]interface{}, restoreSelections bool) {
	...
	m.sourceLocSaveStc = getBool("sourceLocSaveStc", m.sourceLocSaveStc)
	...
	m.sourceLocContrastEnabled = getBool("sourceLocContrastEnabled", m.sourceLocContrastEnabled)
	m.sourceLocContrastCondition = getString("sourceLocContrastCondition", m.sourceLocContrastCondition)
	m.sourceLocContrastA = getString("sourceLocContrastA", m.sourceLocContrastA)
	m.sourceLocContrastB = getString("sourceLocContrastB", m.sourceLocContrastB)
	m.sourceLocContrastMinTrials = getInt("sourceLocContrastMinTrials", m.sourceLocContrastMinTrials)
	m.sourceLocContrastWelchStats = getBool("sourceLocContrastWelchStats", m.sourceLocContrastWelchStats)
	...
	m.correlationsPowerSegment = getString("correlationsPowerSegment", m.correlationsPowerSegment)
	...
	m.prepCleanEventsQCEnabled = getBool("prepCleanEventsQCEnabled", m.prepCleanEventsQCEnabled)
	m.prepCleanEventsQCEcgVarianceEnabled = getBool("prepCleanEventsQCEcgVarianceEnabled", m.prepCleanEventsQCEcgVarianceEnabled)
	m.prepCleanEventsQCEcgVarianceOutputColumn = getString("prepCleanEventsQCEcgVarianceOutputColumn", m.prepCleanEventsQCEcgVarianceOutputColumn)
	m.prepCleanEventsQCEcgVarianceChannels = getString("prepCleanEventsQCEcgVarianceChannels", m.prepCleanEventsQCEcgVarianceChannels)
	m.prepCleanEventsQCEcgVarianceWindow = getString("prepCleanEventsQCEcgVarianceWindow", m.prepCleanEventsQCEcgVarianceWindow)
	m.prepCleanEventsQCPeripheralLowGammaEnabled = getBool("prepCleanEventsQCPeripheralLowGammaEnabled", m.prepCleanEventsQCPeripheralLowGammaEnabled)
	m.prepCleanEventsQCPeripheralLowGammaOutputColumn = getString("prepCleanEventsQCPeripheralLowGammaOutputColumn", m.prepCleanEventsQCPeripheralLowGammaOutputColumn)
	m.prepCleanEventsQCPeripheralLowGammaChannels = getString("prepCleanEventsQCPeripheralLowGammaChannels", m.prepCleanEventsQCPeripheralLowGammaChannels)
	m.prepCleanEventsQCPeripheralLowGammaBand = getString("prepCleanEventsQCPeripheralLowGammaBand", m.prepCleanEventsQCPeripheralLowGammaBand)
	m.prepCleanEventsQCPeripheralLowGammaWindow = getString("prepCleanEventsQCPeripheralLowGammaWindow", m.prepCleanEventsQCPeripheralLowGammaWindow)
	...
	m.fmriAnalysisCondAColumn = getString("fmriAnalysisCondAColumn", m.fmriAnalysisCondAColumn)
	m.fmriAnalysisCondAValue = getString("fmriAnalysisCondAValue", m.fmriAnalysisCondAValue)
	m.fmriAnalysisCondBColumn = getString("fmriAnalysisCondBColumn", m.fmriAnalysisCondBColumn)
	...
	m.fmriAnalysisScopeColumn = getString("fmriAnalysisScopeColumn", m.fmriAnalysisScopeColumn)
	m.fmriAnalysisScopeTrialTypes = getString("fmriAnalysisScopeTrialTypes", m.fmriAnalysisScopeTrialTypes)
	m.fmriAnalysisPhaseColumn = getString("fmriAnalysisPhaseColumn", m.fmriAnalysisPhaseColumn)
	m.fmriAnalysisPhaseScopeColumn = getString("fmriAnalysisPhaseScopeColumn", m.fmriAnalysisPhaseScopeColumn)
	m.fmriAnalysisPhaseScopeValue = getString("fmriAnalysisPhaseScopeValue", m.fmriAnalysisPhaseScopeValue)
	m.fmriAnalysisStimPhasesToModel = getString("fmriAnalysisStimPhasesToModel", m.fmriAnalysisStimPhasesToModel)
	...
	m.fmriTrialSigSignatureOption1 = getBool("fmriTrialSigSignatureOption1", m.fmriTrialSigSignatureOption1)
	m.fmriTrialSigSignatureOption2 = getBool("fmriTrialSigSignatureOption2", m.fmriTrialSigSignatureOption2)
	...
	m.fmriTrialSigScopeTrialTypeColumn = getString("fmriTrialSigScopeTrialTypeColumn", m.fmriTrialSigScopeTrialTypeColumn)
	m.fmriTrialSigScopePhaseColumn = getString("fmriTrialSigScopePhaseColumn", m.fmriTrialSigScopePhaseColumn)
