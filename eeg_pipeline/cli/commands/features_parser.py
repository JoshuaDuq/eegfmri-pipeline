...
def setup_features(subparsers: argparse._SubParsersAction) -> argparse.ArgumentParser:
    ...
    parser.add_argument("--source-contrast-welch-stats", action="store_true", default=None, dest="source_contrast_welch_stats", help="Emit Welch t/p statistics in source contrast outputs.")
    parser.add_argument("--source-contrast-no-welch-stats", action="store_false", dest="source_contrast_welch_stats", help="Disable Welch t/p statistics in source contrast outputs.")
