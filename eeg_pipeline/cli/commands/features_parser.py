...
def setup_features(subparsers: argparse._SubParsersAction) -> argparse.ArgumentParser:
    ...
    parser.add_argument("--source-save-stc", action="store_true", default=None, dest="source_save_stc", help="Save condition-averaged source estimates (STC) for plotting.")
    parser.add_argument("--no-source-save-stc", action="store_false", dest="source_save_stc", help="Disable saving condition-averaged source estimates (STC).")
    ...
    parser.add_argument("--source-contrast", action="store_true", default=None, dest="source_contrast_enabled", help="Enable source condition-contrast summary features.")
    parser.add_argument("--no-source-contrast", action="store_false", dest="source_contrast_enabled", help="Disable source condition-contrast summary features.")
    parser.add_argument("--source-contrast-condition-column", default=None, help="Events column used to define source contrast groups.")
    ...
    parser.add_argument("--source-contrast-min-trials-per-condition", type=int, default=None, help="Minimum trials required per condition for source contrast (default: 5).")
    parser.add_argument("--source-contrast-welch-stats", action="store_true", default=None, dest="source_contrast_welch_stats", help="Request Welch t/p statistics in source contrast outputs. This now errors because trial-level within-subject Welch inference is scientifically invalid.")
    parser.add_argument("--source-contrast-no-welch-stats", action="store_false", dest="source_contrast_welch_stats", help="Keep source contrast outputs descriptive-only (recommended and default).")
    ...
    parser.add_argument("--source-fmri-output-space", choices=["cluster", "atlas", "dual"], default=None, help="Output space for fMRI-constrained source features: cluster (subject-specific clusters), atlas (aparc+aseg labels), or dual (both).")
