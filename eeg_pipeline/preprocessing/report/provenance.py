...
PROVENANCE_KEYS = (
    ...
    ("report.analysis.bcg_residual_window_s", "Beat-locked residual epoch (s)"),
    ("report.analysis.bcg_residual_baseline_s", "Beat-locked residual baseline (s)"),
    ("report.analysis.bcg_residual_measurement_s", "Beat-locked residual window (s)"),
    ...
    ("report.thresholds.repetition_time_tolerance_s", "Shared repetition-time tolerance (s)"),
