...
def generate_config(path='example_config.py', mne_bids_type="minimal"):
    with open(path, 'w') as f:
        ...
        f.write("# NOTE: Feature extraction is now handled by the separate feature pipeline.\n")
        f.write("# After preprocessing, run: eeg-pipeline features --task <task> --subjects <subjects>\n")
