...
def build_stage_runners_impl(
    *,
    ...
    stage_pain_residual_fn: Callable[[Any, Any], Any],
    stage_temperature_models_fn: Callable[[Any, Any], Any],
    ...
    stage_pain_sensitivity_fn: Callable[[Any, Any], Any],
    ...
    return {
        ...
        "pain_residual": lambda ctx, config, outputs: stage_pain_residual_fn(ctx, config),
        "temperature_models": lambda ctx, config, outputs: stage_temperature_models_fn(ctx, config),
        ...
        "pain_sensitivity": lambda ctx, config, outputs: stage_pain_sensitivity_fn(ctx, config),
...
def build_stage_runners_from_namespace_impl(
    ...
    *,
    ...
    return build_stage_runners_impl(
        ...
        stage_pain_residual_fn=ns["stage_pain_residual"],
        stage_temperature_models_fn=ns["stage_temperature_models"],
        ...
        stage_pain_sensitivity_fn=ns["stage_pain_sensitivity"],
