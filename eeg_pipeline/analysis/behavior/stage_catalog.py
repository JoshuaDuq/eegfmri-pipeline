...
PIPELINE_STAGE_RULES: Tuple[PipelineStageRule, ...] = (
    ...
    PipelineStageRule("run_pain_residual", ("pain_residual",)),
    PipelineStageRule("run_temperature_models", ("temperature_models",)),
    ...
    PipelineStageRule("compute_pain_sensitivity", ("pain_sensitivity",)),
...
COMPUTATION_TO_PIPELINE_ATTR = {
    ...
    "pain_residual": "run_pain_residual",
    "temperature_models": "run_temperature_models",
    ...
    "pain_sensitivity": "compute_pain_sensitivity",
...
STAGE_SPEC_DEFINITIONS: Tuple[StageSpecDefinition, ...] = (
    StageSpecDefinition(
        ...
        requires=(),
        produces=("rating", "temperature", "features"),
        group="data_prep",
    ),
    StageSpecDefinition(
        name="trial_table",
    ...
    StageSpecDefinition(
        ...
        requires=("trial_table", "temperature", "rating"),
        produces=("pain_residual",),
        config_key="behavior_analysis.pain_residual.enabled",
        group="data_prep",
    ),
    StageSpecDefinition(
        ...
        config_key="behavior_analysis.temperature_models.enabled",
        group="data_prep",
    ),
    StageSpecDefinition(
        name="feature_qc",
    ...
    StageSpecDefinition(
        ...
        config_key="behavior_analysis.pain_sensitivity.enabled",
        group="correlations",
    ),
    StageSpecDefinition(
        name="regression",
