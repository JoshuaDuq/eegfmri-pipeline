...
def compute_cluster_masses_1d(
    ...
    for cluster_id in range(1, n_components + 1):
        ...
        if cluster_region.any():
            ...
            cluster_masses_dict[cluster_id] = float(cluster_mass)
    
    return full_labels, cluster_masses_dict
...
def compute_cluster_pvalues_1d(
    ...
    """Compute 1D cluster p-values (alias for compute_cluster_pvalues_2d)."""
    return compute_cluster_pvalues_2d(cluster_labels, cluster_masses, perm_max_masses, alpha)
