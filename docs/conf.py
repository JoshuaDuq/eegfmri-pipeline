...
html_theme_options = {
    # Palette mirrors the TUI's "Monochrome Research Terminal" theme — pure
    # grayscale with no chromatic accents. Brand color resolves to the
    # brightest off-white; emphasis is carried by weight, not hue.
    "dark_css_variables": {
