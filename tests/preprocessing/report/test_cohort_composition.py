...
def test_a_row_states_the_paradigm_and_the_pipeline() -> None:
...
def test_no_cohort_carries_an_acquisition_context_warning() -> None:
    """The axis that warning described was removed; nothing may resurrect the prose."""
    html = composition_html(_cohort(_participant("0014"), _participant("0015")))

    assert "acquisition context" not in html
