...
from studies.pain_study.scripts.eeg_raw_to_bids import run_raw_to_bids
...
def test_native_fif_conversion_lets_mne_bids_create_participant_rows(
    ...
    source_file = (
        source_eeg
        / "sub-0001_task-thermalactive_run-1_desc-mriartifactclean_raw.fif"
    )
...
def test_native_fif_conversion_discards_terminal_volume_without_data(
    ...
    source_file = (
        source_eeg
        / "sub-0002_task-thermalactive_run-1_desc-mriartifactclean_raw.fif"
    )
    ...
    events_path = (
        ...
        / "sub-0002"
        / "eeg"
        / "sub-0002_task-thermalactive_run-1_events.tsv"
    )
